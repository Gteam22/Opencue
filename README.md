...
turn owns one monotonic session ID. The plugin's accepted `listening` status
keeps the turn alive even on devices that do not emit audio-level callbacks in
silence. Partial text updates
