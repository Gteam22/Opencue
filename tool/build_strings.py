...
add('assist.autoSpeakHint', 'Read the primary reply aloud after each recognized turn.', '認識した発話への最初の返答を音声で読み上げます。')
...
add('assist.subtitle', 'Tap Listen for one turn, understand what was said, and choose a natural reply.', '「聞く」をタップして一回の発話を認識し、内容に合った返答を提案します。')
