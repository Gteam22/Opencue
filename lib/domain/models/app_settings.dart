...
class AppSettings {
  const AppSettings({
    ...
    this.conversationAssistAutoSpeakEnabled = true,
  ...
  /// Automatically reads the primary Listen Mode reply. On by default for the
  /// FU exchange behavior and persisted independently from the per-language
  /// TTS availability toggles.
  ...
  static AppSettings fromJson(Map<String, Object?> json) {
    ...
    return AppSettings(
      ...
      conversationAssistAutoSpeakEnabled:
          json['conversationAssistAutoSpeakEnabled'] != false,
      conversationLibraryVersion:
  ...
  static AppSettings fromStringMap(Map<String, String> map) {
    return AppSettings(
      ...
      conversationAssistAutoSpeakEnabled:
          map['conversationAssistAutoSpeakEnabled'] != 'false',
      conversationLibraryVersion:
