...
class SpeechController extends ChangeNotifier {
  ...
  Future<void> _toggle({
    ...
    // Starting a new line supersedes any previous one. Do not send an
    // unconditional stop before every fresh utterance: on some Android TTS
    // engines that late cancel callback can cancel the utterance being queued.
    final generation = ++_generation;
    if (_speakingKey != null) await _service.stop();
    _lastError = null;
